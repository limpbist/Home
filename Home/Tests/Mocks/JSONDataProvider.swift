...
struct JSONDataProvider {
    static let animeDTOResponse: String = """
{
    "pagination": {
        "last_visible_page": 1030,
        "has_next_page": true,
        "current_page": 1,
        "items": {
            "count": 25,
